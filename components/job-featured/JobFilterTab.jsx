...
const JobFilterTab = () => {
  ...
  const [tabs, setTab] = useState([
    { id: 1, name: "Tous", isActive: false },
    { id: 2, name: "A domicile", isActive: true },
    { id: 3, name: "Design", isActive: false },
    { id: 4, name: "Santé", isActive: false },
    { id: 5, name: "Management", isActive: false },
    { id: 6, name: "Autres", isActive: false },
  ]);
